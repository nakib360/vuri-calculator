export const analyzeData = (data) => {
  ...
  if (softDrinkCount >= 2) {
    flags.push("চিনির প্রতি অস্বাভাবিক আকর্ষণ ধরা পড়েছে");
  }

  if (softDrinkCount >= 4) {
    flags.push("অতিরিক্ত কোমল পানীয় গ্রহণ শনাক্ত হয়েছে");
    titles.push("চিনির সম্রাট");
  }

  if (teaCount >= 4) {
    flags.push("চায়ের উপর নির্ভরশীলতা দেখা যাচ্ছে");
    titles.push("চা চালিত মানব");
  }

  if (riceCount >= 8) {
    flags.push("অস্বাভাবিক পরিমাণ ভাত গ্রহণ শনাক্ত হয়েছে");
  ...
  if (score >= 35) {
    flags.push("অতিরিক্ত খাদ্য গ্রহণের প্রবণতা পাওয়া গেছে");
  ...
  if (rutiCount >= 8) {
    funnyComments.push(
      ...
      "বেলন আপনাকে সম্মানসূচক সালাম দিচ্ছে।"
    );
  ...
  if (
    ...
    funnyComments.push(
      ...
      "রাতের খাবারে আপনার আত্মনিয়ন্ত্রণ হারিয়ে যায়।"
    );
  ...
  if (score > 30) {
    funnyComments.push(
      ...
      "আপনি মানুষ নাকি খাদ্য শোষণকারী কৃষ্ণগহ্বর বুঝা যাচ্ছে না।"
    );
  }
